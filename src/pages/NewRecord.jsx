  ...
  useEffect(() => {
    ...
    const cargarRegistro = async () => {
      ...
      if (data.tipo_solicitud !== 'ONOMÁSTICO' && data.salida) {
        ...
        // If it ends next day, enable cross-midnight
        if (data.ingreso) {
  ...
  const guardarRegistro = async (e) => {
    ...
    try {
      ...
      const duplicado = filas.find(r => {
        ...
        if (esEdicion && r?._tabla === 'nuevo_registro_horas' && String(r?.nro_registro) === String(nroRegistro)) return false
